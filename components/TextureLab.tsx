        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 md:order-1">
                ...
                >
                    ...
                    <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-300 pointer-events-none ${showMagnifier ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className="order-1 md:order-2">
                ...
                <p className="font-mono text-foreground/70 mb-8 text-sm md:text-base leading-relaxed">
                    ...
                    <br/><br/>
                    We invite you to <strong className="text-white">zoom in</strong>. Inspect the pores, the film grain, and the iris details. Our engine renders texture, not just shapes.
                </p>
